...
#set_property PACKAGE_PIN W15 [get_ports {num[0]}]					
#	 set_property IOSTANDARD LVCMOS33 [get_ports {num[0]}]
#set_property PACKAGE_PIN V15 [get_ports {num[1]}]					
#	 set_property IOSTANDARD LVCMOS33 [get_ports {num[1]}]
#set_property PACKAGE_PIN W14 [get_ports {num[2]}]					
#	 set_property IOSTANDARD LVCMOS33 [get_ports {num[2]}]
#set_property PACKAGE_PIN W13 [get_ports {num[3]}]					
...
# set_property PACKAGE_PIN W2 [get_ports {al_load}]					
	# set_property IOSTANDARD LVCMOS33 [get_ports {al_load}]
# set_property PACKAGE_PIN U1 [get_ports {al_load}]					
# 	set_property IOSTANDARD LVCMOS33 [get_ports {al_load}]
...
set_property PACKAGE_PIN U18 [get_ports show_sec]						
	 set_property IOSTANDARD LVCMOS33 [get_ports show_sec]
set_property PACKAGE_PIN T18 [get_ports inc_btn]						
	 set_property IOSTANDARD LVCMOS33 [get_ports inc_btn]
set_property PACKAGE_PIN W19 [get_ports lshift_btn]						
	 set_property IOSTANDARD LVCMOS33 [get_ports lshift_btn]
set_property PACKAGE_PIN T17 [get_ports rshift_btn]						
	 set_property IOSTANDARD LVCMOS33 [get_ports rshift_btn]
set_property PACKAGE_PIN U17 [get_ports dec_btn]						
	 set_property IOSTANDARD LVCMOS33 [get_ports dec_btn]
